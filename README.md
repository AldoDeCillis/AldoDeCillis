...
- ⚡ Skilled in **rapidly learning** new stacks (like Python & React) and applying them directly to production environments.
- 🤝 Experienced in **autonomous project management** and bridging the gap between technical teams and business stakeholders.
...
<td align="center" width="96" style="background-color: #f8f9fa; padding: 10px; border-radius: 8px;">
<img src="https://raw.githubusercontent.com/simple-icons/simple-icons/develop/icons/jsonwebtokens.svg" width="48" height="48" alt="JWT" />
<br>JWT Auth
</td>
<td align="center" width="96" style="background-color: #f8f9fa; padding: 10px; border-radius: 8px;">
...
<td align="center" width="96" style="background-color: #f8f9fa; padding: 10px; border-radius: 8px;">
<img src="https://raw.githubusercontent.com/simple-icons/simple-icons/develop/icons/opentofu.svg" width="48" height="48" alt="Open Tofu" />
<br>Open Tofu
</td>
<td align="center" width="96" style="background-color: #f8f9fa; padding: 10px; border-radius: 8px;">
...
<td align="center" width="96" style="background-color: #f8f9fa; padding: 10px; border-radius: 8px;">
<img src="https://raw.githubusercontent.com/simple-icons/simple-icons/develop/icons/anthropic.svg" width="48" height="48" alt="Claude" />
<br>Claude
</td>
<td align="center" width="96" style="background-color: #f8f9fa; padding: 10px; border-radius: 8px;">
<img src="[https://cdn.jsdelivr.net/gh/joacoc/crewai@main/docs/img/logo_crewai.png](https://image.pitchbook.com/2XVVuTm07bRnpk2Di32KQqzhrcs1729604907482_200x200)" width="48" height="48" alt="CrewAI" />
<br>CrewAI
</td>
<td align="center" width="96" style="background-color: #f8f9fa; padding: 10px; border-radius: 8px;">
